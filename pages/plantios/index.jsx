...
import Images from "../../components/plantations/grid";
import { TreeIcon, CarbonIcon } from "../../components/vectors/custom";
          ...
          <div className="m-6 sm:mx-10 sm:mt-10">
            ...
            <div className="">
              <div className="flex flex-row justify-between mt-10">
                ...
                <Link href="/galeria">
                  <a className="flex items-center px-4 py-1 text-xs font-medium text-green-500 uppercase bg-white rounded-full">
                    Ver Todas
                  </a>
                </Link>
              </div>
